...
public class AgendaTest {
    ...
    public void testFindByTitle(){
        assertEquals(simple, agenda.findByTitle("Simple event"));
    }
    ...
    public void isFreeFor(){
        ...
        Event plusTot = new Event("plusTot", nov_1__2020_22_00, min_120);
        Event plusTard = new Event("plusTard", nov_1__2020_23_00, min_120);
        Event bon = new Event("bon", nov_1__2020_17_00, min_120);
        assertFalse(agenda.isFreeFor(plusTot));
        assertFalse(agenda.isFreeFor(plusTard));
        assertTrue(agenda.isFreeFor(bon));
    }
